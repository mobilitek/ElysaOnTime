...
export function AdminUsersPage(props: Props) {
  ...
  return <main className="app-page">
    ...
    <section className="content-shell admin-shell">
      <div className="page-heading"><div><p className="eyebrow">ONTIME ADMIN</p><h1>{text.title}</h1><p>{text.subtitle}</p></div><button className="add-button" onClick={openCreate}><span>+</span>{text.add}</button></div>
