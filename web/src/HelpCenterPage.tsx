...
export const HELP_CONTENT = {
  fr: {
    ...
    manualSections: [
      ...
      ['Export Excel', 'L’export reprend la période et les filtres affichés. Il produit le format destiné au client, sans la colonne Facturé. Les lignes de description commençant par trois traits d’union ne sont pas exportées. Si un projet actif du client utilise une banque d’heures, un rappel vous demande de confirmer ou de réviser les semaines concernées avant de poursuivre.'],
  ...
  en: {
    ...
    manualSections: [
      ...
      ['Excel export', 'The export follows the displayed period and filters. It produces the client-facing format without the Billed column. Description lines beginning with three hyphens are not exported. If an active project for the client uses an hour bank, a reminder asks you to confirm or review the affected weeks before continuing.'],
