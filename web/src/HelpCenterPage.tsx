    ...
    releases: [
      {
        ...
        date: '7 août 2026',
        changes: [
          'Séparateur des avis de notes internes remplacé par des astérisques afin d’éviter toute confusion avec les anciens marqueurs internes.',
        ],
      },
      {
        version: '0.4.10',
      ...
      },
      {
        ...
        date: '7 août 2026',
        changes: [
          'Libellé OnTime redondant retiré des titres des principales pages.',
          'Action Inverser facturation intégrée à la rangée du résumé du journal.',
        ],
      },
      {
        version: '0.4.7',
    ...
    releases: [
      {
        ...
        date: 'August 7, 2026',
        changes: [
          'Internal-note notice separator changed to asterisks to avoid conflicts with legacy internal markers.',
        ],
      },
      {
        version: '0.4.10',
      ...
      },
      {
        ...
        date: 'August 7, 2026',
        changes: [
          'Redundant OnTime label removed from the main page headings.',
          'Toggle billed action integrated into the work-log summary row.',
        ],
      },
      {
        version: '0.4.7',
