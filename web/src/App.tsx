...
export function App() {
  ...
  if (!isCheckingSession && user) {
    ...
    if (page === 'profile') return withHelp(<ProfilePage language={language} user={user} systemInfo={systemInfo} systemInfoError={systemInfoError} onUserChange={setUser} onLanguageChange={selectLanguage} onLogout={logout} onNavigateWorkLog={() => setPage('worklog')} onNavigateClients={() => setPage('clients')} onNavigateProjects={() => setPage('projects')} onNavigateAdmin={() => setPage('admin')} />, 'profile', 'profile');
